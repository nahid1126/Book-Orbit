...
@Composable
fun GemsScreen(sharedViewModel: MainViewModel) {
    LaunchedEffect(Unit) {
        sharedViewModel.updateUiState(sharedViewModel.uiState.value.copy(title = "Buy Gems"))
    }
    Surface(
        ...
        Column(
            ...
            Text(text = "Gems Screen", color = Black)
        }
    }
}